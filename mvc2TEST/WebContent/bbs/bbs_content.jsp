                ...
                <div class="col-lg-8 col-md-10 col-sm-12 join-form">
                    <h2>게시판 상세보기<small>(디자인이궁금하세요?)</small></h2>
                        ...
                        <div class="form-group">
                            <label>등록일</label>
                            <input type="text" value="${vo.regdate }" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>글번호</label>
                            <input type="text" value="${vo.bno }" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>글쓴이</label>
                            <input type="text" value="${vo.writer }" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>제목</label>
                            <input type="text" value="${vo.title }" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label>내용</label>
                        ...
                        <div class="form-group">
                            <label>조회수</label>
                            <input type="text" value="${vo.hit }" class="form-control" readonly>
                        </div>
